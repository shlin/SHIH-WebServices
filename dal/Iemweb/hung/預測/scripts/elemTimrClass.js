...
function AO_timr(theParent, theName, theInitialValue,
  ...
  // member functions
  this.init = AO_timrInit;
  this.reset = AO_timrReset;
  this.enable = AO_timrEnable;
  this.disable = AO_timrDisable;
  this.setDisabled = AO_timrSetDisabled;
  this.update = AO_timrUpdate;
  this.setValue = AO_timrSetValue;

  this.step = AO_timrStep;
  this.getClosestFrame = AO_timrGetClosestFrame;
  this.waitTick = AO_timrWaitTick;
  this.preloadFrame = AO_timrPreloadFrame;
  this.getFrameSrc = AO_timrGetFrameSrc;

}

// Initializes the element
function AO_timrInit() {
  var theSrc, extIndex, undIndex;
  with (this) {
    _obj = AO_findObject(_parent._self + _name + "Img");
...
function AO_timrSetValue(theValue) {
  with (this) {
...
function AO_timrGetClosestFrame(theTime) {
  var frame;
  with (this) {
...
function AO_timrGetFrameSrc(theFrame) {
  var iTest, numberStr;
  with (this) {
...
function AO_timrTrig(theParent, theElement, theName,
  ...
  // method
  this.validValue = AO_timrTrigValidValue;
  this.setDisabled = AO_timrTrigSetDisabled;
  this.setSelected = AO_timrTrigSetSelected;
}

//Returns true if value is above this threshold.
function AO_timrTrigValidValue() {
  with (this) {
    selected = false;
...
function AO_timrTrigSetDisabled(theDisabled) {
  with (this) {
...
function AO_timrTrigSetSelected(theSelected) {
  with (this) {
    if (theSelected) {
