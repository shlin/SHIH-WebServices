...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    │<a href="../Statistics/Statistics.asp">Statistics</a></span></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><img src="../../img/left.gif" alt="left" width="4" height="250" align="right" /></td>
    <td valign="top"><table width="760" border="0" align="center" cellpadding="00" cellspacing="0"   id="leftlink">
      <tr>
        ...
        <td colspan="6" valign="top"><table width="760" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td><a href="news_content.asp"><img src="../../img/menu/2.gif" alt="決策新聞" name="b" width="140" height="20" border="0" id="b" onmouseover="MM_swapImage('b','','../../img/menu/2-g.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
              </tr>
              <tr>
                <td><img src="../../img/line.gif" alt="line" width="126" height="8" /></td>
              </tr>
              <tr>
                <td><a href="../../get_content.asp?id=2"><img src="../../img/menu/12.gif" alt="研究成員" name="c" width="140" height="20" border="0" id="c" onmouseover="MM_swapImage('c','','../../img/menu/12-g.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
              </tr>
              <tr>
                <td><img src="../../img/line.gif" alt="line" width="126" height="8" /></td>
              </tr>
              ...
              <tr>
                <td><a href="../guestbook/book.asp"><img src="../../img/menu/11.gif" alt="留言板" name="j" width="140" height="20" border="0" id="j" onmouseover="MM_swapImage('j','','../../img/menu/11-g.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
              </tr>
              <tr>
                <td><img src="../../img/line.gif" alt="line" width="126" height="8" /></td>
              </tr>
            ...
            <td align="center" valign="top"><table width="600" height="188" border="0" cellpadding="0" cellspacing="0" class="tb_border" id="link_content">
                <tr>
                  <td height="45" valign="bottom" background="../../img/MenuBg3.gif"><div align="center">
                    <p class="InsideTitle"><img src="../../img/InsideIcon.gif" alt="Icon" width="14" height="14" align="absmiddle" />News<br />
                      <br />
                    </p>
                    </div>                      </td>
                </tr>
                <tr>
                  <td height="100%" align="left" valign="top" background="../../img/tb_bg6_0.gif"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><% = fuploadtime%></td>
                      <td><% = fdesc%></td>
                    </tr>
                ...
                <tr>
                  <td height="43" background="../../img/tb_bg6_1.gif"><div align="right" class="smalltext">Update：<img src="../../img/w.gif" alt="w" width="15" height="15" /></div></td>
                </tr>
                </table>              
              </td>
          </tr>
