...
FileTypeName = GetFileTypeName(FileName)
		...
		if ftitle<>"" and fileSize > 0 and UploadSize=True then
			...
			dim basepath,sql
			basepath = "./../../File/決策新聞/"
			sql = "insert into INFO(filetitle,filedesc,filetype,FILEFrom,filecontenttype,filepath,NewsTime,filesize) values('"
			sql =  sql & ftitle &"','"&filedesc&"','"&ftype&"','"&ffrom&"','"&file_ctype&"','"&basepath&filename&"','"&ftime&"',"&filesize&")"
			myconn.Execute(sql)
...
<title>上傳程式</title>
<meta http-equiv="refresh" content="3";URL="../../get_content_news.asp?id=10">
</head>
				...
				<div align="center">
					<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="80%" id="table4">
						<tr>
							...
							<br><br><div align="center">本頁將在3秒後返回 如果您的瀏覽器沒有反應，請<a href="get_content_news.asp?id=10">點擊此處返回</a></div>
