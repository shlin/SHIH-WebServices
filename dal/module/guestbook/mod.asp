...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE dbo.GuestBook SET Name = ?, Email = ?, Subject = ?, Memo = ?, [Time] = ?, ClientIP = ? WHERE mid = ?" 
    ...
    MM_editRedirectUrl = "mod_del.asp"
    If (Request.QueryString <> "") Then
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="95%" align="center">
    <tr valign="baseline">
      <td width="118" valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">姓名│Name</div></td>
      <td><input name="Name" type="text" class="text" value="<%=(gb.Fields.Item("Name").Value)%>" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">信箱│E-mail</div></td>
      <td><input name="Email" type="text" class="text" value="<%=(gb.Fields.Item("Email").Value)%>" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">主題│Subject</div></td>
      <td><input name="Subject" type="text" class="text" value="<%=(gb.Fields.Item("Subject").Value)%>" size="32"></td>
    </tr>
    <tr>
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">內容│Memo</div></td>
      <td valign="baseline"> <textarea name="Memo" cols="50" rows="5" class="text" wrap="OFF" ><%=(gb.Fields.Item("Memo").Value)%></textarea></td>
    </tr>
    <tr valign="baseline">
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">時間│Time</div></td>
      <td><input name="Time" type="text" class="text" value="<%=(gb.Fields.Item("Time").Value)%>" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">位址│IP add. </div></td>
      <td class="smalltext">
...
<input name="ClientIP" type="hidden" value="<%Response.write (ClientIP)%>" /></td>
  ...
  <input type="hidden" name="MM_recordId" value="<%= gb.Fields.Item("mid").Value %>">
