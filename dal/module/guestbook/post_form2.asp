...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.GuestBook (Name, Email, Subject, Memo, [Time], ClientIP,notInput) VALUES (?, ?, ?, ?, ?, ?, '123')" 
    MM_editCmd.Prepared = true
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param1", 202, 1, 255, Request.Form("userName")) ' adVarWChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param2", 202, 1, 255, Request.Form("Email_Real")) ' adVarWChar
...
gb_cmd.CommandText = "SELECT * FROM dbo.GuestBook" 
        ...
        <td colspan="6" valign="top"><table width="760" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="center" valign="top"><table width="600" height="188" border="0" cellpadding="0" cellspacing="0" class="tb_border" id="link_content">
                ...
                <tr>
                  <td height="100%" align="left" valign="top" background="../../img/tb_bg6_0.gif"><div align="left">
				  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
  <table width="95%" align="center">
    <tr valign="baseline">
      <td width="118" valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">姓名│Name</div></td>
      <td><input name="userName" type="text" class="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline" style="display: none;">
      ...
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">信箱│E-mail</div></td>
      <td><input name="Email_Real" type="text" class="text" value="" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">主題│Subject</div></td>
      <td><input name="Subject" type="text" class="text" value="" size="32"></td>
    </tr>
    <tr>
      <td valign="top" bordercolor="#000000" bordercolorlight="#C0C0C0"><div align="left">內容│Memo</div></td>
      <td valign="baseline"> <textarea name="Memo" cols="50" rows="5" class="text" wrap="OFF" ></textarea></td>
    </tr>
    <tr valign="baseline">
