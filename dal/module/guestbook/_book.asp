...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><div align="right"><span class="smalltext">Hits :
        ...
        │<a href="module/Statistics/Statistics.asp">Statistics</a></span></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
            ...
            <td align="center" valign="top"><table width="600" height="188" border="0" cellpadding="0" cellspacing="0" class="tb_border" id="link_content">
                ...
                <tr>
                  <td height="100%" align="center" valign="middle" background="../../img/tb_bg6_0.gif"><div align="left">
                    <p align="left"><img src="../../img/w.gif" alt="white" width="15" height="15" /><a href="form.asp">留言│Post</a></p>
                      <table width="95%" border="0" align="center" class="smalltext">
                        <tr>
                          ...
                          <div align="center" class="smalltext">留言<%=(gb_first)%> 到 <%=(gb_last)%> / 共 <%=(gb_total)%> 則 <br />
                      </div>
                      <table width="100%" border="0" cellpadding="4" cellspacing="4" bordercolor="#000000" bordercolorlight="#C0C0C0" id="table1">
    <tr>
      <td colspan="2"><hr align="center" width="90%" /></td>
    </tr>
   <% 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td background="../../img/tb/2-a.gif"><p>&nbsp;</p>
        <p>&nbsp;</p></td>
    <td><p>&nbsp;</p>
        <p>&nbsp;</p></td>
  ...
  <tr>
    <td background="../../img/tb/3-a.gif">&nbsp;</td>
    ...
    <tr>
      <td width="118"><div align="left">姓名│Name</div></td>
      <td width="423"><%=(gb.Fields.Item("Name").Value)%></td>
    </tr>
    <tr>
      <td><div align="left">信箱│E-mail</div></td>
      <td><a href="mailto://<%=(gb.Fields.Item("Email").Value)%>"><%=(gb.Fields.Item("Email").Value)%></a></td>
    </tr>
    <tr>
      <td><div align="left">主題│Subject</div></td>
    ...
    <tr>
      <td><div align="left">內容│Memo</div></td>
    ...
    <tr>
      <td><div align="left">時間│Time</div></td>
      <td><%=(gb.Fields.Item("Time").Value)%></td>
    </tr>
    <tr>
      <td><div align="left">位址│IP add. </div></td>
      <td><%=(gb.Fields.Item("ClientIP").Value)%></td>
    </tr>
    <tr>
      <td colspan="2"><div align="right" class="smalltext">No.<%=(gb.Fields.Item("mid").Value)%></div></td>
      </tr>
    <tr>
      <td colspan="2"><div align="right"><a href="reply.asp?mid=<%=(gb.Fields.Item("mid").Value)%>">回覆│Reply</a></div></td>
    </tr>
    <tr>
      <td colspan="2"><hr align="center" width="90%" /></td>
    </tr>
