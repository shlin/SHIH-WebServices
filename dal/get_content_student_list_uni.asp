...
studentDB_cmd.CommandText = "SELECT * FROM dbo.Student WHERE [year] = ? AND class LIKE '大學生'" 
studentDB_cmd.Prepared = true
studentDB_cmd.Parameters.Append studentDB_cmd.CreateParameter("param1", 200, 1, 255, studentDB__MMColParam) ' adVarChar
...
%>
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><div align="center">
        <p><%=(studentDB.Fields.Item("name").Value)%><br />
          <br />
    ...
    <tr>
      <td height="1"><img src="img/line.gif" alt="line" width="100%" height="8" /><br />
        <br /></td>
    </tr>
  </table>
  <% 
