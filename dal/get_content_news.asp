...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <tr>
    ...
    │Today : <%=date%></span></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><img src="img/left.gif" alt="left" width="4" height="250" align="right" /></td>
    <td valign="top"><table width="760" border="0" align="center" cellpadding="00" cellspacing="0"   id="leftlink" class="border">
      <tr>
        ...
        <td colspan="6" valign="top"><table width="760" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="center" valign="top"><table width="600" height="198" border="0" cellpadding="0" cellspacing="0" class="tb_border" id="link_content">
                ...
                <tr>
                  <td height="95%" align="left" valign="top" background="img/tb_bg6_0.gif">
				 
				    <div align="center">
				      <!--#include virtual="/module/news/index.asp" -->
				        </div></td>
                </tr>
                <tr>
                  <td height="40" background="img/tb_bg6_1.gif"><div align="right" class="smalltext"><img src="img/w.gif" alt="w" width="15" height="15" /></div></td>
                </tr>
                </table>              
              </td>
          </tr>
